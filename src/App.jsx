...
const metaForWrite = (current) => ({ ...current, menu: stripMenuImages(current.menu), menuVersion: MENU_VERSION });
...
/* Bump this whenever SEED_MENU changes in a way we want to force onto every
   device — e.g. replacing the whole menu with a new card. On load, if the menu
   saved in the database has an older (or missing) version, the app overwrites it
   with the SEED_MENU below and saves the new version back. This is why a brand
   new full menu shows up even when an old menu was already saved in Firestore. */
const MENU_VERSION = 2;
const SEED_MENU = [
  { id: "m1", name: "Beef Chapshoro", price: 400, em: "🫓", cat: "Appetizers", desc: "Beef & veg seasoning with homemade spices, stuffed in dough", badge: "", available: true, branches: BOTH },
  { id: "m2", name: "Chicken Chapshoro", price: 450, em: "🫓", cat: "Appetizers", desc: "Chicken & veg seasoning with homemade spices, stuffed in dough", badge: "", available: true, branches: BOTH },
  { id: "m3", name: "Chicken Dumplings (12p)", price: 460, em: "🥟", img: IMG_CHICKEN_MOMOS, cat: "Appetizers", desc: "Juicy chicken filling wrapped in tender dough, steamed to perfection", badge: "Popular", available: true, branches: BOTH },
  { id: "m4", name: "Chicken Dumplings (6p)", price: 230, em: "🥟", img: IMG_CHICKEN_MOMOS, cat: "Appetizers", desc: "Juicy chicken filling wrapped in tender dough, steamed to perfection", badge: "", available: true, branches: BOTH },
  { id: "m5", name: "Beef Dumplings (12p)", price: 400, em: "🥟", cat: "Appetizers", desc: "Juicy beef filling wrapped in tender dough, steamed to perfection", badge: "", available: true, branches: BOTH },
  { id: "m6", name: "Beef Dumplings (6p)", price: 200, em: "🥟", cat: "Appetizers", desc: "Juicy beef filling wrapped in tender dough, steamed to perfection", badge: "", available: true, branches: BOTH },
  { id: "m7", name: "Yok Dumplings (12p)", price: 900, em: "🥟", cat: "Appetizers", desc: "Juicy filling wrapped in tender dough, steamed to perfection", badge: "", available: true, branches: BOTH },
  { id: "m8", name: "Yok Dumplings (6p)", price: 500, em: "🥟", cat: "Appetizers", desc: "Juicy filling wrapped in tender dough, steamed to perfection", badge: "", available: true, branches: BOTH },
  { id: "m9", name: "Crispy Chicken Wings (6p)", price: 550, em: "🍗", cat: "Appetizers", desc: "Crispy fried chicken wings", badge: "", available: true, branches: BOTH },
  { id: "m10", name: "Honey Wings (6p)", price: 650, em: "🍗", cat: "Appetizers", desc: "Wings glazed in honey sauce", badge: "", available: true, branches: BOTH },
  { id: "m11", name: "BBQ Wings (6p)", price: 650, em: "🍗", cat: "Appetizers", desc: "Smoky BBQ chicken wings", badge: "", available: true, branches: BOTH },
  { id: "m12", name: "Hot Wings (6p)", price: 650, em: "🍗", cat: "Appetizers", desc: "Spicy hot chicken wings", badge: "Spicy", available: true, branches: BOTH },
  { id: "m13", name: "Chicken Manchurian", price: 570, em: "🍲", img: IMG_CHICKEN_MANCHURIAN, cat: "Meals", desc: "Crispy chicken stir-fried in a special sauce, served with egg fried rice", badge: "Popular", available: true, branches: BOTH },
  { id: "m14", name: "Chicken Chili Dry", price: 600, em: "🍗", cat: "Meals", desc: "Chicken stir-fried in a spicy chili sauce, served with egg fried rice", badge: "Spicy", available: true, branches: BOTH },
  { id: "m15", name: "Chicken Shashilik", price: 600, em: "🍢", cat: "Meals", desc: "Chicken marinated in a blend of spices, stir-fried with veg in a homemade sauce", badge: "", available: true, branches: BOTH },
  { id: "m16", name: "Chicken Chili Dry with Chowmein", price: 650, em: "🍜", cat: "Meals", desc: "Chicken stir-fried in a spicy chili sauce, served with chowmein", badge: "Spicy", available: true, branches: BOTH },
  { id: "m17", name: "Kung Pao Chicken", price: 650, em: "🥜", cat: "Meals", desc: "Chicken stir-fried with peanuts, veg & sechuan in savory sauce, served with egg fried rice", badge: "", available: true, branches: BOTH },
  { id: "m18", name: "Sweet & Sour Chicken", price: 650, em: "🍍", cat: "Meals", desc: "Chicken stir-fried with white sugar, brown sugar or pineapple juice, served with egg fried rice", badge: "", available: true, branches: BOTH },
  { id: "m19", name: "Chicken Cashewnut", price: 750, em: "🥜", cat: "Meals", desc: "Stir-fried chicken with roasted peanut, veg & sechuan chili in savory sauce, served with egg fried rice", badge: "", available: true, branches: BOTH },
  { id: "m20", name: "Chicken Chili Dry Gravy", price: 650, em: "🍛", cat: "Meals", desc: "Chicken stir-fried in a spicy chili sauce, served with egg fried rice", badge: "Spicy", available: true, branches: BOTH },
  { id: "m21", name: "Chicken Black Pepper", price: 600, em: "🌶️", cat: "Meals", desc: "Chicken stir-fried in black pepper, served with egg fried rice", badge: "", available: true, branches: BOTH },
  { id: "m22", name: "Beef Chili Dry with Chowmein", price: 750, em: "🍜", cat: "Meals", desc: "Beef stir-fried in a spicy chili sauce, served with chowmein", badge: "Spicy", available: true, branches: BOTH },
  { id: "m23", name: "Beef Chili Dry", price: 770, em: "🥩", cat: "Meals", desc: "Beef stir-fried in a spicy chili sauce, served with egg fried rice", badge: "Spicy", available: true, branches: BOTH },
  { id: "m24", name: "Yok Chili Dry", price: 1200, em: "🥩", cat: "Meals", desc: "Yok stir-fried in a spicy chili sauce, served with egg fried rice", badge: "Spicy", available: true, branches: BOTH },
  { id: "m25", name: "Chicken Manchurian Bowl", price: 570, em: "🍲", cat: "Gravy Bowls", desc: "Crispy chicken stir-fried in a special sauce", badge: "Popular", available: true, branches: BOTH },
  { id: "m26", name: "Chicken Chili Dry Bowl", price: 600, em: "🍜", cat: "Gravy Bowls", desc: "Chicken stir-fried in a spicy chili sauce", badge: "Spicy", available: true, branches: BOTH },
  { id: "m27", name: "Chicken Shashilik Bowl", price: 600, em: "🍢", cat: "Gravy Bowls", desc: "Chicken marinated in a blend of spices, stir-fried with veg in a homemade sauce", badge: "", available: true, branches: BOTH },
  { id: "m28", name: "Kung Pao Chicken Bowl", price: 650, em: "🥜", cat: "Gravy Bowls", desc: "Chicken stir-fried with peanuts, veg & sechuan in savory sauce", badge: "", available: true, branches: BOTH },
  { id: "m29", name: "Yok Chilli Dry Bowl", price: 650, em: "🥩", cat: "Gravy Bowls", desc: "Yok stir-fried with peanuts, veg & sechuan in savory sauce", badge: "", available: true, branches: BOTH },
  { id: "m30", name: "Beef Chili Dry Bowl", price: 770, em: "🥩", cat: "Gravy Bowls", desc: "Beef stir-fried in a spicy chili sauce", badge: "Spicy", available: true, branches: BOTH },
  { id: "m31", name: "Chicken Cashewnut Bowl", price: 750, em: "🥜", cat: "Gravy Bowls", desc: "Stir-fried chicken with roasted peanut, veg & sechuan chili in savory sauce", badge: "", available: true, branches: BOTH },
  { id: "m32", name: "Chicken Chili Dry Gravy Bowl", price: 650, em: "🍛", cat: "Gravy Bowls", desc: "Chicken stir-fried in a spicy chili sauce", badge: "Spicy", available: true, branches: BOTH },
  { id: "m33", name: "Chicken Black Pepper with Gravy", price: 600, em: "🌶️", cat: "Gravy Bowls", desc: "Chicken stir-fried in black pepper", badge: "", available: true, branches: BOTH },
  { id: "m34", name: "Sweet & Sour Chicken Bowl", price: 650, em: "🍍", cat: "Gravy Bowls", desc: "Chicken stir-fried with white sugar, brown sugar or pineapple juice", badge: "", available: true, branches: BOTH },
  { id: "m35", name: "Hot & Sour Soup (Small)", price: 230, em: "🍲", cat: "Soups", desc: "A soup loaded with ingredients for a tongue-tingling experience", badge: "", available: true, branches: BOTH },
  { id: "m36", name: "Hot & Sour Soup (Full)", price: 650, em: "🍲", cat: "Soups", desc: "A soup loaded with ingredients for a tongue-tingling experience", badge: "", available: true, branches: BOTH },
  { id: "m37", name: "Chi Corn Soup (Small)", price: 230, em: "🌽", cat: "Soups", desc: "A delicious chicken soup that is perfect for any day", badge: "", available: true, branches: BOTH },
  { id: "m38", name: "Chi Corn Soup (Full)", price: 600, em: "🌽", cat: "Soups", desc: "A delicious chicken soup that is perfect for any day", badge: "", available: true, branches: BOTH },
  { id: "m39", name: "Beef Dawodo Soup (Small)", price: 300, em: "🍜", cat: "Soups", desc: "Traditional mouth-watering soup with tender noodles, comforting broth & tangy yak cheese", badge: "", available: true, branches: BOTH },
  { id: "m40", name: "Beef Dawodo Soup (Full)", price: 700, em: "🍜", cat: "Soups", desc: "Traditional mouth-watering soup with tender noodles, comforting broth & tangy yak cheese", badge: "", available: true, branches: BOTH },
  { id: "m41", name: "Chicken Dawodo Soup (Small)", price: 300, em: "🍜", cat: "Soups", desc: "Traditional mouth-watering soup with tender noodles, comforting broth & tangy yak cheese", badge: "", available: true, branches: BOTH },
  { id: "m42", name: "Chicken Dawodo Soup (Full)", price: 700, em: "🍜", cat: "Soups", desc: "Traditional mouth-watering soup with tender noodles, comforting broth & tangy yak cheese", badge: "", available: true, branches: BOTH },
  { id: "m43", name: "HZ Special Soup (Small)", price: 250, em: "🍲", cat: "Soups", desc: "Traditional mouth-watering soup with tender noodles", badge: "", available: true, branches: BOTH },
  { id: "m44", name: "HZ Special Soup (Full)", price: 700, em: "🍲", cat: "Soups", desc: "Traditional mouth-watering soup with tender noodles", badge: "", available: true, branches: BOTH },
  { id: "m45", name: "Yok Dawodo Soup (Small)", price: 400, em: "🍜", cat: "Soups", desc: "Traditional mouth-watering soup with tender noodles", badge: "", available: true, branches: BOTH },
  { id: "m46", name: "Yok Dawodo Soup (Full)", price: 900, em: "🍜", cat: "Soups", desc: "Traditional mouth-watering soup with tender noodles", badge: "", available: true, branches: BOTH },
  { id: "m47", name: "Chicken Chowmein", price: 450, em: "🍜", img: IMG_CHICKEN_CHOW_MEIN, cat: "Noodles", desc: "Tender chicken, crunchy veggies & noodles stir-fried in a rich soy-based sauce", badge: "Popular", available: true, branches: BOTH },
  { id: "m48", name: "Veg Chowmein", price: 350, em: "🍜", cat: "Noodles", desc: "Crunchy veggies & noodles stir-fried in a rich soy-based sauce", badge: "", available: true, branches: BOTH },
  { id: "m49", name: "Beef Chowmein", price: 500, em: "🍜", cat: "Noodles", desc: "Tender beef, crunchy veggies & noodles stir-fried in a rich soy-based sauce", badge: "", available: true, branches: BOTH },
  { id: "m50", name: "Shanghai Noodles", price: 550, em: "🍜", cat: "Noodles", desc: "Stir-fried lulean cut veg, fully spicy & spiced", badge: "Spicy", available: true, branches: BOTH },
  { id: "m51", name: "Sizzle Sp Chicken Noodles", price: 480, em: "🍜", cat: "Noodles", desc: "Stir-fried lulean cut veg with our homemade noodles & spices", badge: "", available: true, branches: BOTH },
  { id: "m52", name: "Sizzle Sp Beef Noodles", price: 500, em: "🍜", cat: "Noodles", desc: "Stir-fried lulean cut veg with our homemade noodles & spices", badge: "", available: true, branches: BOTH },
  { id: "m53", name: "Thai Executive Noodles", price: 550, em: "🍜", cat: "Noodles", desc: "Homemade noodles served in a rich broth with veg and chicken", badge: "", available: true, branches: BOTH },
  { id: "m54", name: "Soaltee Noodles", price: 550, em: "🍜", cat: "Noodles", desc: "Homemade noodles served in a rich broth with veg and chicken", badge: "", available: true, branches: BOTH },
  { id: "m55", name: "Veg Rice", price: 280, em: "🍚", cat: "Rice", desc: "Flavorful mix of sauteed veggies and aromatic spices with fluffy rice", badge: "", available: true, branches: BOTH },
  { id: "m56", name: "Masala Rice", price: 350, em: "🍚", cat: "Rice", desc: "Spicy and savory masala rice with flavorful spices & chili sauce", badge: "Spicy", available: true, branches: BOTH },
  { id: "m57", name: "Chicken Fried Rice", price: 350, em: "🍚", cat: "Rice", desc: "Chicken marinated in a blend of spices, stir-fried with veg in a homemade sauce", badge: "", available: true, branches: BOTH },
  { id: "m58", name: "Egg Fried Rice", price: 300, em: "🍳", cat: "Rice", desc: "Scrambled eggs, veggies and flavorful rice, stir-fried to perfection", badge: "", available: true, branches: BOTH },
  { id: "m59", name: "Sizzle Special Rice", price: 380, em: "🍚", cat: "Rice", desc: "Flavorful rice, veggies and spices, sizzling hot with multiple protein", badge: "Popular", available: true, branches: BOTH },
  { id: "m60", name: "White Rice", price: 250, em: "🍚", cat: "Rice", desc: "Only white rice served", badge: "", available: true, branches: BOTH },
  { id: "m61", name: "Garlic Rice", price: 300, em: "🧄", cat: "Rice", desc: "Served with vegetable & garlic", badge: "", available: true, branches: BOTH },
  { id: "m62", name: "Alfredo Pasta", price: 650, em: "🍝", cat: "Pasta", desc: "Made with homemade noodles", badge: "", available: true, branches: BOTH },
  { id: "m63", name: "Laqman (Beef)", price: 500, em: "🍜", cat: "Pasta", desc: "Homemade noodle served in rich flavored broth with seasonal veggies, garnished with herbs & spring onions", badge: "", available: true, branches: BOTH },
  { id: "m64", name: "Soman", price: 500, em: "🍝", cat: "Pasta", desc: "Homemade noodles served in a rich broth with veg and chicken", badge: "", available: true, branches: BOTH },
  { id: "m65", name: "Chicken Chili Dry Combo (3p)", price: 650, em: "🍱", cat: "Combo Bowls", desc: "Chicken chili dry, chowmein, egg fried rice and dumplings", badge: "Deal", available: true, branches: BOTH },
  { id: "m66", name: "Beef Chili Dry Combo (3p)", price: 800, em: "🍱", cat: "Combo Bowls", desc: "Beef chili dry, chowmein, egg fried rice and dumplings", badge: "Deal", available: true, branches: BOTH },
  { id: "m67", name: "Chowmein Combo (3p)", price: 800, em: "🍱", cat: "Combo Bowls", desc: "Chowmein, egg fried rice and dumplings — choose any gravy", badge: "Deal", available: true, branches: BOTH },
  { id: "m68", name: "Masala Fries", price: 230, em: "🍟", cat: "Snacks", desc: "Crispy fries tossed in masala", badge: "", available: true, branches: BOTH },
  { id: "m69", name: "Mayo Fries", price: 250, em: "🍟", cat: "Snacks", desc: "Fries loaded with creamy mayo", badge: "", available: true, branches: BOTH },
  { id: "m70", name: "Fries", price: 200, em: "🍟", cat: "Snacks", desc: "Classic crispy fries", badge: "", available: true, branches: BOTH },
  { id: "m71", name: "Zinger Burger", price: 400, em: "🍔", cat: "Snacks", desc: "Crispy zinger fillet, lettuce & mayo", badge: "", available: true, branches: BOTH },
  { id: "m72", name: "Mango Shake", price: 200, em: "🥤", cat: "Beverages", desc: "Fresh mango shake", badge: "", available: true, branches: BOTH },
  { id: "m73", name: "Banana Shake", price: 200, em: "🥤", cat: "Beverages", desc: "Creamy banana shake", badge: "", available: true, branches: BOTH },
  { id: "m74", name: "Strawberry Shake", price: 200, em: "🥤", cat: "Beverages", desc: "Sweet strawberry shake", badge: "", available: true, branches: BOTH },
  { id: "m75", name: "Apricot Shake", price: 250, em: "🥤", cat: "Beverages", desc: "Hunza apricot shake", badge: "", available: true, branches: BOTH },
  { id: "m76", name: "Cherry Shake", price: 350, em: "🥤", cat: "Beverages", desc: "Rich cherry shake", badge: "", available: true, branches: BOTH },
  { id: "m77", name: "Tumuro Tea", price: 100, em: "🍵", cat: "Tea", desc: "Traditional Hunza tumuro herbal tea", badge: "", available: true, branches: BOTH },
];
      ...
      try {
        ...
        if (!mSnap.exists()) {
          ...
          /* The meta doc already exists (e.g. from an earlier version / a test
             ...
             the new SEED_MENU (and version) so every device — including the
             public website — starts showing the new menu right away. Anything
             else in the doc (inventory, staff, etc.) is left untouched. */
          const existing = mSnap.data() || {};
          if ((existing.menuVersion || 0) < MENU_VERSION) {
            await setDoc(mRef, { menu: stripMenuImages(SEED_MENU), menuVersion: MENU_VERSION }, { merge: true });
          }
        }
    ...
    const unsubMeta = onSnapshot(doc(db, "hunza", "meta"), { includeMetadataChanges: false }, (snap) => {
      ...
      if (JSON.stringify(d) !== JSON.stringify(remoteMetaRef.current)) {
        ...
        /* Only trust the menu coming from the database if it's at least as new
           ...
           writing the new menu back to Firestore, and this snapshot is just the
...
function MenuEditRow({ it, cats, onCancel, onSave }) {
  ...
  /* Same shrink-on-upload as the Add form: draw the chosen photo onto a canvas
     at max 320px and re-encode as JPEG ~0.7 (~10–20 KB) so it's small enough to
     store in the shared menu document (Firestore caps a doc at 1 MB) and the new
     picture survives a refresh. This lets staff CHANGE a dish's photo while
     editing, not just paste a URL. */
  const onFile = (e) => {
    const f = e.target.files?.[0]; if (!f) return;
    if (f.size > 8 * 1024 * 1024) { setUerr("Photo under 8MB please."); return; }
    const r = new FileReader();
    r.onload = () => {
      const img = new Image();
      img.onload = () => {
        ...
        let out; try { out = cv.toDataURL("image/jpeg", 0.7); } catch (_) { out = r.result; }
        setIm(out); setUerr("");
      };
      img.onerror = () => { setIm(r.result); };
      img.src = r.result;
    };
    r.readAsDataURL(f);
  };
  return (
    <div className="hz-editrow">
      ...
      <div className="hz-form">
        <label>Dish photo
          <label className="hz-upload">{im ? <img src={im} alt="preview" onError={(e) => { e.target.style.display = "none"; }} /> : <div className="hz-upload-ph"><ImagePlus size={26} /><span>Tap to change photo</span></div>}<input type="file" accept="image/*" onChange={onFile} hidden /></label>
        </label>
        {im && <button className="hz-ghost sm" onClick={() => setIm("")}><X size={12} />Remove photo</button>}
        {uerr && <div className="hz-err"><CircleAlert size={13} />{uerr}</div>}
        <label>Item name<input value={n} onChange={(e) => setN(e.target.value)} /></label>
        <div className="hz-row2">
        ...
        <label>…or paste a photo URL<input value={im.startsWith("data:") ? "" : im} onChange={(e) => setIm(e.target.value.trim())} placeholder="https://…/dish.jpg (optional)" /></label>
        <div className="hz-corow2">
          <button className="hz-ghost" onClick={onCancel}><X size={14} />Cancel</button>
...
.hz-ghost.sm{padding:5px 10px;font-size:11.5px;align-self:flex-start;margin-top:-4px;}
